...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #FF6500;">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <a class="nav-link <?= $_GET['page'] == 'profile' ? 'active' : ''; ?>" href="./profile.php?page=profile"
                    style="padding: 10px 15px;">Profil</a>
