...
if (!$_SESSION['login']) {
    ...
    $id = $_SESSION['id'];
    $data = query("SELECT * FROM pemesanan WHERE id_pelanggan = '$id' AND is_deleted = 0 ORDER BY status ASC");
        ...
        <div class="container">
            <div class="row justify-content-center">
                <?php foreach ($data as $pesanan) : ?>
                    <div class="col-lg-3 col-md-4 col-sm-6 mb-5" id="card-<?= $pesanan['id'] ?>">
                        <div class="card" style="width: 98%; margin: auto;">
                            ...
                            <form id="hapus-form-<?= $pesanan['id'] ?>" action="" method="POST" autocomplete="off">
