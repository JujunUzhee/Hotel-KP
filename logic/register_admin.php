...
<body class="bg-primary">
            ...
            <main class="mt-5">
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-10">
                        <h4 class="mt-5 text-center">Registrasi Pegawai</h4>
                            ...
                            <div class="container">
                                <div class="row g-3">
                                    <div class="col-sm-6">
                                        ...
                                        <input style="background-color: #e8f0fe;" type="text" name="nama" class="form-control" id="nama" required placeholder="Nama">
                                    </div>
                                    <div class="col-lg-6">
                                        <label for="username" class="form-label">Username</label>
                                        <input style="background-color: #e8f0fe;" type="text" name="username" class="form-control" id="username" placeholder="Username" required>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="password">Password</label>
                                            <div class="input-group" id="show_hide_password">
                                                <input type="password" style="background-color: #e8f0fe;" name='password' class="form-control" required placeholder="Password">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group" id="show_hide_password_2">
                                                <input type="password" style="background-color: #e8f0fe;" name='confirm-password' class="form-control" required placeholder="Konfirmasi Password">
                                                <div class="input-group-append">
                                                    <a href="" class="btn btn-outline-secondary"><i class="bi bi-eye-slash" aria-hidden="true"></i></a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input style="background-color: #e8f0fe;" type="email" name="email" class="form-control" id="email" placeholder="Email" required>
                                    </div>
                                    <div class="col-lg-6">
                                        <label for="telp" class="form-label">Telepon</label>
                                        <input style="background-color: #e8f0fe;" type="text" name="telp" class="form-control" id="telp" placeholder="No HP" required>
                                    </div>
                                    <div class="col-lg-12">
                                        <label for="jenis-kelamin" class="form-label">Jenis Kelamin</label>
                                        <select name="jenis-kelamin" id="jenis-kelamin" style="background-color: #e8f0fe;" class="form-select" required>
                                    ...
                                    <div class="col-lg-12">
                                      ...
                                      <select name="role" id="role" style="background-color: #e8f0fe;" class="form-select" required>
    ...
    if (isset($_GET['pesan'])) {
        if ($_GET['pesan'] == "invalid-username") {
            echo "<script>
                Swal.fire({
                icon: 'error',
        ...
        if ($_GET['pesan'] == "invalid-password") {
            echo "<script>
                Swal.fire({
                icon: 'error',
                title: 'Registrasi Gagal',
